...
C_SRCS += \
../cleanflight/src/main/msp/msp_serial.c 

OBJS += \
./cleanflight/src/main/msp/msp_serial.o 

C_DEPS += \
./cleanflight/src/main/msp/msp_serial.d 


# Each subdirectory must supply rules for building sources it contributes
cleanflight/src/main/msp/%.o: ../cleanflight/src/main/msp/%.c
	@echo 'Building file: $<'
