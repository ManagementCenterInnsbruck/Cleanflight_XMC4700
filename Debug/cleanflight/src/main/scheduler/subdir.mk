...
C_SRCS += \
../cleanflight/src/main/scheduler/scheduler.c 

OBJS += \
./cleanflight/src/main/scheduler/scheduler.o 

C_DEPS += \
./cleanflight/src/main/scheduler/scheduler.d 


# Each subdirectory must supply rules for building sources it contributes
cleanflight/src/main/scheduler/%.o: ../cleanflight/src/main/scheduler/%.c
	@echo 'Building file: $<'
