...
bool spiInit(SPIDevice device)
{
    ...
    case SPIDEV_1:
        ...
        return true;
#elif defined(USE_SPIS_DEVICE_1)
        spiSlaveInitDevice(device);
        return true;
#else
        break;
#endif
    case SPIDEV_2:
        ...
        spiInitDevice(device);
        return true;
#elif defined(USE_SPIS_DEVICE_2)
        spiSlaveInitDevice(device);
        return true;
#else
        break;
    ...
    case SPIDEV_3:
        ...
        spiInitDevice(device);
        return true;
#elif defined(USE_SPIS_DEVICE_3)
        spiSlaveInitDevice(device);
        return true;
#else
        break;
    ...
    case SPIDEV_4:
        ...
        spiInitDevice(device);
        return true;
#elif defined(USE_SPIS_DEVICE_4)
        spiSlaveInitDevice(device);
        return true;
#else
        break;
    ...
    case SPIDEV_5:
    	...
    	spiInitDevice(device);
#elif defined(USE_SPIS_DEVICE_5)
        spiSlaveInitDevice(device);
        return true;
#else
    	break;
    ...
    case SPIDEV_6:
    	...
    	spiInitDevice(device);
#elif defined(USE_SPIS_DEVICE_6)
        spiSlaveInitDevice(device);
        return true;
#else
    	break;
