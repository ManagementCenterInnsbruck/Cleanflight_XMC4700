...
#define SPI_IO_AF_SCK_CFG       XMC_GPIO_MODE_OUTPUT_PUSH_PULL
#define SPI_IO_AF_MOSI_CFG      XMC_GPIO_MODE_OUTPUT_PUSH_PULL
#define SPI_IO_AF_MISO_CFG      XMC_GPIO_MODE_OUTPUT_PUSH_PULL
#define SPI_IO_CS_CFG           XMC_GPIO_MODE_OUTPUT_PUSH_PULL | 0x01
#endif
