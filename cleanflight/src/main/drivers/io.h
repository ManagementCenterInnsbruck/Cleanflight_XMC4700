...
# define IOCFG_OUT_PP         XMC_GPIO_MODE_OUTPUT_PUSH_PULL
# define IOCFG_OUT_OD         XMC_GPIO_MODE_OUTPUT_OPEN_DRAIN
# define IOCFG_AF_PP          XMC_GPIO_MODE_OUTPUT_PUSH_PULL
# define IOCFG_AF_OD          XMC_GPIO_MODE_OUTPUT_OPEN_DRAIN
# define IOCFG_IPD            XMC_GPIO_MODE_INPUT_PULL_DOWN
# define IOCFG_IPU            XMC_GPIO_MODE_INPUT_PULL_UP
# define IOCFG_IN_FLOATING    XMC_GPIO_MODE_INPUT_TRISTATE
