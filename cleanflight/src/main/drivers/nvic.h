...
#define NVIC_PRIO_SERIALSPIS1			   NVIC_BUILD_PRIORITY(1, 0)
#define NVIC_PRIO_SERIALSPIS2			   NVIC_BUILD_PRIORITY(1, 0)
#define NVIC_PRIO_SERIALSPIS3			   NVIC_BUILD_PRIORITY(1, 0)
#define NVIC_PRIO_SERIALSPIS4			   NVIC_BUILD_PRIORITY(1, 0)
#define NVIC_PRIO_SERIALSPIS5			   NVIC_BUILD_PRIORITY(1, 0)
#define NVIC_PRIO_SERIALSPIS6			   NVIC_BUILD_PRIORITY(1, 0)
