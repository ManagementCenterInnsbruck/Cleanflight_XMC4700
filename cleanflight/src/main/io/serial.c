...
#if defined(USE_SPIS_DEVICE_1) || defined(USE_SPIS_DEVICE_2) || defined(USE_SPIS_DEVICE_3) || defined(USE_SPIS_DEVICE_4) || defined(USE_SPIS_DEVICE_5) || defined(USE_SPIS_DEVICE_6)
...
#endif
#ifdef USE_SPIS_DEVICE_1
	SERIAL_PORT_SPIS1,
#endif
#ifdef USE_SPIS_DEVICE_2
	SERIAL_PORT_SPIS2,
#endif
#ifdef USE_SPIS_DEVICE_3
	SERIAL_PORT_SPIS3,
#endif
#ifdef USE_SPIS_DEVICE_4
	SERIAL_PORT_SPIS4,
#endif
#ifdef USE_SPIS_DEVICE_5
	SERIAL_PORT_SPIS5,
#endif
#ifdef USE_SPIS_DEVICE_6
	SERIAL_PORT_SPIS6,
#endif
};
    ...
    portOptions_e options)
{
    ...
    switch (identifier) {
        ...
        case SERIAL_PORT_SPIS1:
        	serialPort = spiSlaveOpen(SPIDEV_1, rxCallback, rxCallbackData, baudRate, mode, options);
		break;
#endif
#ifdef USE_SPIS_DEVICE_2
        case SERIAL_PORT_SPIS2:
        	serialPort = spiSlaveOpen(SPIDEV_2, rxCallback, rxCallbackData, baudRate, mode, options);
		break;
#endif
#ifdef USE_SPIS_DEVICE_3
        case SERIAL_PORT_SPIS3:
        	serialPort = spiSlaveOpen(SPIDEV_3, rxCallback, rxCallbackData, baudRate, mode, options);
		break;
#endif
#ifdef USE_SPIS_DEVICE_4
        case SERIAL_PORT_SPIS4:
        	serialPort = spiSlaveOpen(SPIDEV_4, rxCallback, rxCallbackData, baudRate, mode, options);
		break;
#endif
#ifdef USE_SPIS_DEVICE_5
        case SERIAL_PORT_SPIS5:
        	serialPort = spiSlaveOpen(SPIDEV_5, rxCallback, rxCallbackData, baudRate, mode, options);
		break;
#endif
#ifdef USE_SPIS_DEVICE_6
        case SERIAL_PORT_SPIS6:
        	serialPort = spiSlaveOpen(SPIDEV_6, rxCallback, rxCallbackData, baudRate, mode, options);
		break;
#endif
        default:
            break;
