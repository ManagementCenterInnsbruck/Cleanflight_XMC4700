...
#if defined(USE_SPI_DEVICE_1) || defined(USE_SPIS_DEVICE_1)
    { SPIDEV_1, IO_TAG(SPI1_SCK_PIN), IO_TAG(SPI1_MISO_PIN), IO_TAG(SPI1_MOSI_PIN) },
#endif
#if defined(USE_SPI_DEVICE_2) || defined(USE_SPIS_DEVICE_2)
    { SPIDEV_2, IO_TAG(SPI2_SCK_PIN), IO_TAG(SPI2_MISO_PIN), IO_TAG(SPI2_MOSI_PIN) },
#endif
#if defined(USE_SPI_DEVICE_3) || defined(USE_SPIS_DEVICE_3)
    { SPIDEV_3, IO_TAG(SPI3_SCK_PIN), IO_TAG(SPI3_MISO_PIN), IO_TAG(SPI3_MOSI_PIN) },
#endif
#if defined(USE_SPI_DEVICE_4) || defined(USE_SPIS_DEVICE_4)
    { SPIDEV_4, IO_TAG(SPI4_SCK_PIN), IO_TAG(SPI4_MISO_PIN), IO_TAG(SPI4_MOSI_PIN) },
#endif
#if defined(USE_SPI_DEVICE_5) || defined(USE_SPIS_DEVICE_5)
    { SPIDEV_5, IO_TAG(SPI5_SCK_PIN), IO_TAG(SPI5_MISO_PIN), IO_TAG(SPI5_MOSI_PIN) },
#endif
#if defined(USE_SPI_DEVICE_6) || defined(USE_SPIS_DEVICE_6)
    { SPIDEV_6, IO_TAG(SPI6_SCK_PIN), IO_TAG(SPI6_MISO_PIN), IO_TAG(SPI6_MOSI_PIN) },
#endif
};
